 ...
 */
final class Version20210508200822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_profile (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, gender_preference VARCHAR(255) DEFAULT NULL, marital_status VARCHAR(255) DEFAULT NULL, dob DATETIME DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, height INT DEFAULT NULL, weight INT DEFAULT NULL, hair_color VARCHAR(255) DEFAULT NULL, eye_color VARCHAR(255) DEFAULT NULL, body_type VARCHAR(255) DEFAULT NULL, ethnicity VARCHAR(255) DEFAULT NULL, sexual_preference VARCHAR(255) DEFAULT NULL, summary VARCHAR(512) DEFAULT NULL, partner_qualities LONGTEXT DEFAULT NULL, interests LONGTEXT DEFAULT NULL, hobbies LONGTEXT DEFAULT NULL, smoking_preference VARCHAR(10) DEFAULT NULL, smoking_status VARCHAR(10) DEFAULT NULL, languages VARCHAR(512) DEFAULT NULL, height_unit VARCHAR(15) DEFAULT NULL, weight_unit VARCHAR(15) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
